namespace roundhouse.folders
{
    public sealed class DefaultKnownFolders : KnownFolders
    {
        public DefaultKnownFolders(
                                   ...
                                   MigrationsFolder runLastAfterEverythingScripts,
                                   Folder change_drop
            )
        {
            ...
            this.run_last_after_everything_scripts = runLastAfterEverythingScripts;
        }
        ...
        public MigrationsFolder run_last_after_everything_scripts { get; private set; }
