...
namespace roundhouse.consoles
{
    ...
    public sealed class DefaultConfiguration : ConfigurationPropertyHolder
    {
        ...
        public string RunLastAfterEverythingScriptsFolderName { get; set; }
        ...
        public IDictionary<string, string> to_token_dictionary()
        {
            ...
            tokens["RunLastAfterEverythingScriptsFolderName"] = RunLastAfterEverythingScriptsFolderName.to_string();
